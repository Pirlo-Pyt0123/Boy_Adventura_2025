...
#include "Boy_Adventura_2025/Obstaculo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AObstaculo_Statics::NewProp_Mesh_MetaData[] = {
		{ "Category", "Obstaculo" },
		{ "Comment", "//esta es su malla o su asecto \n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Obstaculo.h" },
		{ "ToolTip", "esta es su malla o su asecto" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AObstaculo_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x001000000008000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AObstaculo, Mesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AObstaculo_Statics::NewProp_Mesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AObstaculo_Statics::NewProp_Mesh_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AObstaculo_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AObstaculo_Statics::NewProp_Mesh,
	};
	...
	IMPLEMENT_CLASS(AObstaculo, 2325438711);
	template<> BOY_ADVENTURA_2025_API UClass* StaticClass<AObstaculo>()
	{
		return AObstaculo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AObstaculo(Z_Construct_UClass_AObstaculo, &AObstaculo::StaticClass, TEXT("/Script/Boy_Adventura_2025"), TEXT("AObstaculo"), false, nullptr, nullptr, nullptr);
